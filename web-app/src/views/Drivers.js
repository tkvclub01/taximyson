...
export default function Users() {
  ...
  const columns = [
      ...
      { title: language.cmnd, field: 'cmnd',render: rowData => rowData.cmnd?<img alt='License' src={rowData.cmnd} style={{width: 100}}/>:null, editable:'never'},
      { title: language.cmnd_s, field: 'cmndS',render: rowData => rowData.cmndS?<img alt='License' src={rowData.cmndS} style={{width: 100}}/>:null, editable:'never'},
      ...
      { title: language.lisence_image_s,  field: 'licenseSImage',render: rowData => rowData.licenseSImage?<img alt='License' src={rowData.licenseSImage} style={{width: 100}}/>:null, editable:'never'},
      { title: language.anh_bien_so_xe,  field: 'anhBienSoXe',render: rowData => rowData.anhBienSoXe?<img alt='License' src={rowData.anhBienSoXe} style={{width: 100}}/>:null, editable:'never'},
