...
export default function AddMoneyScreen(props) {
    ...
    const [state, setState] = useState({
        ...
        qickMoney: [{amount: '100000', selected: false}, {amount: '200000', selected: false}, {
            amount: '500000',
            selected: false
        }, {amount: '1000000', selected: false}, {amount: '2000000', selected: false}],
    });
    ...
    const newData = ({item, index}) => {
        return (
            <TouchableOpacity
                ...
                style={[styles.quckMoneyText, {color: item.selected ? colors.WHITE : colors.BLACK}]}>{formatPrice(item.amount)}</Text></TouchableOpacity>
        )
    }
        ...
        <View style={styles.mainView}>
            ...
            <View style={styles.bodyContainer}>
                <Text style={styles.walletbalText}>{language.Balance} - <Text
                    style={styles.ballance}>{state.userdata ? formatPrice(state.userdata.walletBalance) : ''}</Text></Text>
