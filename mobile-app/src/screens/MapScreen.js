                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <View style={{alignItems: 'center', flexDirection: 'row', flex: 1, justifyContent: "center"}}>
                            ...
                            <View style={{flex: 1}}>
                                <Text
                                    style={{color: colors.BLACK, fontSize: 16,}}>{language.driver_finding_alert}</Text>
                            </View>
                        </View>
                    </View>
                </View>
            ...
            <View style={styles.myViewStyle}>
                ...
                <View style={styles.iconsViewStyle}>
                    <TouchableOpacity onPress={() => tapAddress('pickup')} style={styles.contentStyle}>
                        <View style={styles.textIconStyle}>
                            <Text numberOfLines={1}
                                  style={[styles.textStyle, tripdata.selected == 'pickup' ? {fontSize: 20} : {fontSize: 14}]}>{tripdata.pickup && tripdata.pickup.add ? tripdata.pickup.add : language.map_screen_where_input_text}</Text>
                            <Icon
                                name='gps-fixed'
                                color={colors.WHITE}
                    ...
                    <TouchableOpacity onPress={() => tapAddress('drop')} style={styles.searchClickStyle}>
                        <View style={styles.textIconStyle}>
                            <Text numberOfLines={1}
                                  style={[styles.textStyle, tripdata.selected == 'drop' ? {fontSize: 20} : {fontSize: 14}]}>{tripdata.drop && tripdata.drop.add ? tripdata.drop.add : language.map_screen_drop_input_text}</Text>
                            <Icon
                                name='search'
                                type='feather'
                                color={colors.WHITE}
            ...
            <View style={styles.mapcontainer}>
                ...
                {tripdata.selected == 'pickup' ?
                    <View pointerEvents="none" style={{
                        ...
                        <Image pointerEvents="none" style={{marginBottom: 40, height: 40, resizeMode: "contain"}}
                        ...
                        {activeBookings.map((booking, key) => {
                            return (
                                <TouchableWithoutFeedback key={key} style={styles.activeBookingItem} onPress={() => {
                                    ...
                                    <Image style={{marginLeft: 10, width: 22, height: 22}}
                                           source={{uri: booking.carImage}} resizeMode={'contain'}/>
                                    <Text style={{
                                        marginLeft: 10,
                                        width: 118,
                                        color: 'red',
                                    ...
                                    <Text style={{
                                        ...
                                        marginRight: 10,
                                        color: colors.BLACK
                                    }} numberOfLines={1} ellipsizeMode='tail'>{booking.drop.add}</Text>
                            ...
                            <View key={key} style={styles.cabDivStyle}>
                                ...
                                <View style={styles.textViewStyle}>
                                    ...
                                    <View style={{flexDirection: 'row', alignItems: 'center'}}>
                                        <Text
                                            style={styles.text2}>{prop.minTime != '' ? prop.minTime : language.not_available}</Text>
                                        {
                                                ...
                                                <Tooltip style={{marginLeft: 3, marginRight: 3}}
                                                         ...
                                                         popover={
                                                             <View style={{
                                                                 ...
                                                                 {
                                                                     prop.extra_info.split(',').map((ln) => <Text
                                                                         key={ln} style={{margin: 5}}>{ln}</Text>)
                                                                 }
                                                             </View>
                                                         }>
                                                    <Icon
                ...
                <View style={{flex: 0.5, flexDirection: 'row'}}>
                    ...
                    >
                        <Text style={{
                            ...
                            fontFamily: 'Roboto-Bold',
                            fontSize: 18
                        }}>{language.book_later_button}</Text>
                    </BaseButton>
                    <BaseButton
                        title={language.book_now_button}
                        loading={false}
