                    ...
                    <View style={styles.mapcontainer}>
                        {paramData ?
                            ...
                            >
                                <Marker
                                    coordinate={{
                                        latitude: paramData ? (paramData.pickup.lat) : 0.00,
                                        longitude: paramData ? (paramData.pickup.lng) : 0.00
                                    }}
                ...
                <View style={styles.rideDesc}>
                    ...
                    <View style={styles.userDesc}>
                        ...
                        <View style={styles.userView}>
                            ...
                            {paramData && paramData.driver_name != '' ?
                                <Text style={styles.personStyle}>{paramData.driver_name}</Text> : null}
                    ...
                    {paramData && paramData.carType ?
                        <View style={[styles.userDesc, styles.avatarView]}>
                            ...
                            />
                            <View style={styles.userView}>
                                <Text style={styles.carNoStyle}>{paramData.vehicle_number ? paramData.vehicle_number :
                                    <Text> {language.car_no_not_found}</Text>}</Text>
                    ...
                    <View style={styles.userDesc}>
                        ...
                        <View style={styles.userView}>
                            <Text
                                style={styles.textStyle}>{paramData && paramData.customer_paid ? formatPrice(paramData.customer_paid) : paramData && paramData.estimate ? formatPrice(paramData.estimate) : formatPrice(0)}</Text>
                        </View>
                    </View>
                </View>
                <View>
                    ...
                    <View style={styles.billView}>
                        ...
                        <View style={styles.billOptions}>
                            <View style={styles.billItem}>
                                ...
                                <Text
                                    style={styles.billAmount}>{paramData && paramData.trip_cost > 0 ? formatPrice(paramData.trip_cost) : paramData && paramData.estimate ? formatPrice(paramData.estimate) : formatPrice(0)}</Text>
                            </View>
                            <View style={styles.billItem}>
                                <View>
                                ...
                                <Text
                                    style={styles.discountAmount}> - {paramData && paramData.discount_amount ? formatPrice(paramData.discount_amount) : formatPrice(0)}</Text>
                            ...
                            {paramData && paramData.cardPaymentAmount ? paramData.cardPaymentAmount > 0 ?
                                <View style={styles.billItem}>
                                    ...
                                    <Text>  {paramData && paramData.cardPaymentAmount ? formatPrice(paramData.cardPaymentAmount) : formatPrice(0)}</Text>
                            ...
                            {paramData && paramData.cashPaymentAmount ? paramData.cashPaymentAmount > 0 ?
                                <View style={styles.billItem}>
                                    ...
                                    <Text>  {paramData && paramData.cashPaymentAmount ? formatPrice(paramData.cashPaymentAmount) : formatPrice(0)}</Text>
                            ...
                            {paramData && paramData.usedWalletMoney ? paramData.usedWalletMoney > 0 ?
                                <View style={styles.billItem}>
                                    ...
                                    <Text>  {paramData && paramData.usedWalletMoney ? formatPrice(paramData.usedWalletMoney) : formatPrice(0)}</Text>
                        ...
                        <View style={styles.paybleAmtView}>
                            ...
                            <Text
                                style={styles.billAmount2}>{paramData && paramData.customer_paid ? formatPrice(paramData.customer_paid) : null}</Text>
                        </View>
                    </View>
                    : null}
                {paramData && ['PENDING', 'PAID', 'COMPLETE'].indexOf(paramData.status) != -1 ?
                            ...
                            <View style={styles.billOptions}>
                                ...
                                {['PAID', 'COMPLETE'].indexOf(paramData.status) != -1 ?
                                    <View style={styles.billItem}>
                                        ...
                                        <Text
                                            style={styles.billAmount}>{paramData.payment_mode ? paramData.payment_mode : null} {paramData.gateway ? '(' + paramData.gateway + ')' : null}</Text>
                                    </View>
                                    : null}
                            </View>
                            : <View style={styles.billOptions}>
