...
export default function SelectGatewayPage(props) {
  ...
  const icons = {
    ...
    'onepay':require('../../assets/payment-icons/onepay-logo.png'),
    'nganluong':require('../../assets/payment-icons/nganluong-logo.png'),
    'vnpay':require('../../assets/payment-icons/vnpay-logo.png'),
    'baokim':require('../../assets/payment-icons/baokim-logo.png')
  }
