...
const FirebaseProvider = ({children}) => {
    ...
    if (!app.apps.length) {
        ...
        firebase = {
            ...
            cmndRef: (uid, timestamp) => app.storage().ref(`users/${uid}/driverDocuments/${timestamp}_cmnd/`),
            cmndSRef: (uid, timestamp) => app.storage().ref(`users/${uid}/driverDocuments/${timestamp}_cmnds/`),
            licenseImageRef: (uid, timestamp) => app.storage().ref(`users/${uid}/driverDocuments/${timestamp}_license/`),
            licenseSImageRef: (uid, timestamp) => app.storage().ref(`users/${uid}/driverDocuments/${timestamp}_licenses/`),
            anhBienSoXeRef: (uid, timestamp) => app.storage().ref(`users/${uid}/driverDocuments/${timestamp}_biensoxe/`),
            ...
            api: {
                ...
                updateCmnd: (userAuthData, imageBlob) => (dispatch) => updateCmnd(userAuthData, imageBlob)(dispatch)(firebase),
                updateCmndS: (userAuthData, imageBlob) => (dispatch) => updateCmndS(userAuthData, imageBlob)(dispatch)(firebase),
                updateLicenseImage: (userAuthData, imageBlob) => (dispatch) => updateLicenseImage(userAuthData, imageBlob)(dispatch)(firebase),
                updateLicenseSImage: (userAuthData, imageBlob) => (dispatch) => updateLicenseSImage(userAuthData, imageBlob)(dispatch)(firebase),
                updateAnhBienSoXe: (userAuthData, imageBlob) => (dispatch) => updateAnhBienSoXe(userAuthData, imageBlob)(dispatch)(firebase),
